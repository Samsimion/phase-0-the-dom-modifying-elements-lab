...
/*describe("index.html", () => {
  describe("after index.js is processed", () => {
    ...
    it("the 'newHeader' variable that points to the <h1> node with an id of 'victory' has the text \"\" (with your name in place of YOUR-NAME) inside it", () => {
      expect(newHeader.innerHTML, "Make sure your <h1> with id 'victory' includes the text \"is the champion\" inside it").to.include("iYOUR-NAME is the champions the champion");
    });
